...
function chain_energy_list = compute_chain_energy_distribution_no_entangle(x, neighbour_matrix, x_init, num_layer, num_width)
            ...
            if (i >= num_width*0.25 && i <= num_width*0.75 && j >= num_layer*0.25 && j <= num_layer*0.75)
                ...
                for k = 1:4
                    ...
                    if (node_index ~= neighbour_index)
                        ...
                        energy = energy_func(stretch) * init_length;

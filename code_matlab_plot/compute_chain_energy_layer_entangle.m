...
function [strech_layer, num_chain_layer] = compute_chain_energy_layer_entangle(x, neighbour_matrix, chain_num, chain_init_len, chain_info, num_layer, num_width)
    ...
    for node_i = 1:dof
        ...
        for l = 1:4
            ...
            if(node_i ~= node_j)
                ...
                chain_node_i = get_chain_index_connect_two_node(node_i, node_j, chain_info, chain_num);
                
                strech_layer(d, num_chain_layer(d)) = strech_info(node_i, chain_node_i);

...
function plot_network_stretch_entangle_init_stretch_max(x, x_init, neighbour_matrix, chain_num, chain_init_len, chain_info, is_cross_linker, fig_name, stretch_max)

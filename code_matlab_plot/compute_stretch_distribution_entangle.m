...
function stretch_list = compute_stretch_distribution_entangle(x, neighbour_matrix, chain_num, chain_init_len, chain_info, num_layer, num_width, is_cross_linker)

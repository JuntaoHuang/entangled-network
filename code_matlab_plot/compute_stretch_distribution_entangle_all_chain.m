...
function stretch_list = compute_stretch_distribution_entangle_all_chain(x, neighbour_matrix, chain_num, chain_init_len, chain_info, num_layer, num_width, is_cross_linker)
    ...
    for i_layer = 1:num_layer
        ...
        for i_width = 1:num_width
            ...
            % get rid of node on top and bottom boundary
            if (i_layer > 1 && i_layer < num_layer && is_cross_linker(i) == 1)            
